...
const AudioEngine = {
  ...
  setTrack(name) {
    ...
    if (this.track) {
      ...
      if (this.started) this._restartMusicTimer();
      else this.resume();
    }
  },
...
const TRACKS = {
  ...
  wedding: {
    bpm: 104, len: 32, vol: 0.54, leadWave: 'triangle', leadLen: 2.4, leadGain: 0.14, brass: true,
    lead: [
      'C5', _, 'G4', _, 'C5', _, 'E5', _, 'G5', _, 'C6', _, 'G5', _, 'E5', _, 'C5', _,
      'F4', _, 'C4', _, 'F4', _, 'A4', _, 'C5', _, 'F5', _, 'C5', _, 'A4', _, 'F4', _,
      'G4', _, 'D4', _, 'G4', _, 'B4', _, 'D5', _, 'G5', _, 'D5', _, 'B4', _, 'G4', _,
      'C5', _, 'G4', _, 'C5', _, 'E5', _, 'G5', 'C6', 'G5', 'E5', 'C5', _, 'G4', 'C5',
    ],
    harm: [
      'E4', 'G4', 'E4', 'G4', 'E4', 'G4', 'E4', 'G4', 'G4', 'B4', 'G4', 'B4', 'G4', 'E4', 'G4', 'E4',
      'A4', 'C5', 'A4', 'C5', 'A4', 'C5', 'A4', 'C5', 'A4', 'F4', 'A4', 'F4', 'A4', 'C5', 'A4', 'F4',
      'B4', 'D5', 'B4', 'D5', 'B4', 'D5', 'B4', 'D5', 'D5', 'G4', 'D5', 'G4', 'D5', 'B4', 'D5', 'G4',
      'E4', 'G4', 'E4', 'G4', 'E4', 'G4', 'E4', 'G4', 'G4', 'C5', 'G4', 'E4', 'G4', 'E4', 'G4', 'C5',
    ],
    bass: [
      'C3', _, _, _, 'C3', _, _, _, 'G2', _, _, _, 'C3', _, _, _,
      'F2', _, _, _, 'F2', _, _, _, 'C3', _, _, _, 'F2', _, _, _,
      'G2', _, _, _, 'G2', _, _, _, 'D3', _, _, _, 'G2', _, _, _,
      'C3', _, _, _, 'E3', _, _, _, 'G2', 'C3', 'G2', 'C3', _, 'G2', 'C3',
    ],
    drum: [
      'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _,
      'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _,
      'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _,
      'k', _, 'h', 'h', 'k', 'k', 'h', _, 'k', _, 'k', 'h', 'k', 'h',
    ],
  },
  weddingEnd: {
    bpm: 88, len: 32, vol: 0.5, leadWave: 'sine', leadLen: 3.4, leadGain: 0.13, brass: true,
    harmWave: 'triangle', harmGain: 0.06, bassGain: 0.14,
    lead: [
      'C5', _, 'G4', _, 'C5', _, 'E5', _, 'G5', _, 'C6', _, 'G5', _, 'E5', _, 'C5', _,
      'F4', _, 'C4', _, 'F4', _, 'A4', _, 'C5', _, 'F5', _, 'C5', _, 'A4', _, 'F4', _,
      'G4', _, 'D4', _, 'G4', _, 'B4', _, 'D5', _, 'G5', _, 'D5', _, 'B4', _, 'G4', _,
      'C5', _, 'G4', _, 'C5', _, 'E5', _, 'G5', 'C6', 'G5', 'E5', 'C5', _, _, 'C5',
    ],
    harm: [
      'E4', _, 'G4', _, 'E4', _, 'G4', _, 'G4', _, 'B4', _, 'G4', _, 'E4', _,
      'A4', _, 'C5', _, 'A4', _, 'C5', _, 'A4', _, 'F4', _, 'A4', _, 'F4', _,
      'B4', _, 'D5', _, 'B4', _, 'D5', _, 'D5', _, 'G4', _, 'D5', _, 'B4', _,
      'E4', _, 'G4', _, 'E4', _, 'G4', _, 'G4', _, 'C5', _, 'E4', _, 'G4', _,
    ],
    bass: [
      'C3', _, _, _, 'C3', _, _, _, 'G2', _, _, _, 'C3', _, _, _,
      'F2', _, _, _, 'F2', _, _, _, 'C3', _, _, _, 'F2', _, _, _,
      'G2', _, _, _, 'G2', _, _, _, 'D3', _, _, _, 'G2', _, _, _,
      'C3', _, _, _, 'E3', _, _, _, 'G2', _, 'C3', _, _, _, 'C3',
    ],
    drum: ['h', _, _, _, 'h', _, _, _, 'h', _, _, _, 'h', _, _, _,
      'h', _, _, _, 'h', _, _, _, 'h', _, _, _, 'h', _, _, _,
      'h', _, _, _, 'h', _, _, _, 'h', _, _, _, 'h', _, _, _,
      'h', _, 'h', _, 'k', _, 'h', _, 'h', _, 'h', _, 'h', 'h'],
  },
};
