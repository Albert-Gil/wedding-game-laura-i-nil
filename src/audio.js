...
const TRACKS = {
  ...
  /* Marxa nupcial (Bridal Chorus) — neges rodones, tempo de marxa */
  wedding: {
    bpm: 80, beatDiv: 1, len: 32, vol: 0.7,
    leadWave: 'sine', leadLen: 0.92, leadGain: 0.38, brass: false,
    harmWave: 'triangle', harmGain: 0.1, bassGain: 0.26, bassWave: 'triangle',
    lead: [
    ...
    harm: [
      'E4', _, _, _, 'G4', _, _, _, 'E4', _, _, _, 'G4', _, _, _,
      'E4', _, 'G4', _, 'E4', _, _, _, 'E4', _, 'G4', _, 'E4', _, _, _,
      'A4', _, _, _, 'C4', _, _, _, 'A4', _, 'C5', _, 'A4', _, _, _,
      'B4', _, _, _, 'D4', _, _, _, 'B4', _, 'G4', _, 'B4', _, _, _,
    ],
    bass: [
      'C3', _, _, _, 'G2', _, _, _, 'C3', _, _, _, 'G2', _, _, _,
      'C3', _, 'G2', _, 'C3', _, 'G2', _, 'C3', _, 'G2', _, 'C3', _, 'G2', _,
      'F2', _, _, _, 'C3', _, _, _, 'F2', _, 'C3', _, 'F2', _, _, _,
      'G2', _, _, _, 'D3', _, _, _, 'G2', _, 'G2', _, 'D3', _, 'G2', _,
    ],
    drum: [
      'k', _, _, _, 'k', _, _, _, 'k', _, _, _, 'k', _, _, _,
      'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _,
      'k', _, _, _, 'k', _, _, _, 'k', _, 'h', _, 'k', _, 'h', _,
      'k', _, _, _, 'k', _, _, _, 'k', _, 'h', 'h', 'k', 'h', 'k', 's',
    ],
  },
  weddingEnd: {
    bpm: 72, beatDiv: 1, len: 16, vol: 0.64,
    leadWave: 'sine', leadLen: 1.05, leadGain: 0.32, brass: false,
    harmWave: 'triangle', harmGain: 0.08, bassGain: 0.2,
    lead: [
      'C5', 'C5', 'C5', 'C5', 'G4', 'G4', 'G4', 'G4',
      'C5', 'E5', 'G5', 'C6', 'G5', 'E5', 'C5', 'G4',
    ],
    harm: [
      'E4', _, _, _, 'G4', _, _, _, 'E4', _, 'G4', _, 'E4', _, _, _,
    ],
    bass: [
      'C3', _, _, _, 'G2', _, _, _, 'C3', _, 'G2', _, 'C3', _, 'G2', _,
    ],
    drum: ['h', _, _, _, 'h', _, _, _, 'h', _, 'h', _, 'h', 'h', 'h', 'h'],
  },
};
