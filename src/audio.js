...
const TRACKS = {
  ...
  wedding: {
    ...
    lead: [
      ...
      _, _, _, _, _, _, 'C4', 'C4', 'C4', 'E4', _, _, _, 'E4',
      'E4', 'E4', 'G4', _, _, _, 'G4', 'G4', 'G4', _, _, _, _, _, 'B4',
      _, _, _, 'E4', 'A4', _, 'G4', _, 'F4', _, 'D4', _, 'C4',
      _, _, _, 'D4', _, _, 'D4', 'F4', 'C4', 'E4', 'G4', _, _, _, _,
      'B4', _, _, 'A4', 'F#4', _, 'G4', _, 'F4', _, 'D4', _, 'C4',
      _, _, 'C4', 'D4', _, _, 'E4', _, _, 'C4', 'E4', _, _, _, _,
      'C4', 'E4', 'G4', _, _, 'B4', _, _, 'A4', 'F4', _, 'G4', _, 'F4', _, 'D4', _, 'C4',
    ],
    harm: [
      'C4', _, _, _, _, _, _, _, _, _, _, _, 'G3', _, _, _,
      _, _, _, _, _, _, 'C4', _, _, 'E4', _, _, _, 'G3',
      'C4', _, 'G3', _, _, _, 'G3', _, _, _, _, _, _, _, 'G3',
      _, _, _, 'C4', _, 'E4', _, 'C4', _, 'A3', _, 'F3', _, 'C4',
      _, _, _, 'D4', _, _, 'D4', _, 'C4', _, 'C4', _, 'G3', _, _, _, _,
      'G3', _, _, 'F3', 'A3', _, 'C4', _, 'B3', _, 'G3', _, 'C4',
      _, _, 'C4', 'D4', _, _, 'E4', _, _, 'C4', 'G3', _, _, _, _,
      'C4', _, 'G3', _, _, 'G3', _, _, 'F3', 'D4', _, 'G3', _, 'F3', _, 'D4', _, 'C4',
    ],
    bass: [
      'C3', _, 'G2', _, 'C3', _, 'G2', _, 'C3', _, 'G2', _, 'C3', _, 'G2', _,
      'C3', _, 'E3', _, 'G2', _, 'C3', _, 'G2', _, 'B2', _, 'G2', _, 'C3', _,
      'C3', _, 'G2', _, 'E3', _, 'G2', _, 'C3', _, 'G2', _, 'B2', _, 'G2', _,
      'C3', _, 'A2', _, 'F3', _, 'G2', _, 'F3', _, 'D3', _, 'C3', _, 'G2', _,
      'D3', _, 'F3', _, 'G2', _, 'C3', _, 'E3', _, 'G2', _, 'B2', _, 'G2', _,
      'C3', _, 'G2', _, 'F#3', _, 'G2', _, 'E3', _, 'C3', _, 'G2', _, 'C3', _,
      'C3', _, 'D3', _, 'E3', _, 'C3', _, 'G2', _, 'C3', _, 'E3', _, 'G2', _,
      'C3', _, 'E3', _, 'G2', _, 'B2', _, 'G2', _, 'A2', _, 'F3', _, 'G2', _, 'C3', _,
    ],
    drum: [
      'k', _, _, _, 'k', _, _, _, 'k', _, _, _, 'k', _, _, _,
      'k', _, 'h', _, 'k', _, _, _, 'k', _, 'h', _, 'k', _, 'h', _,
      'k', _, _, _, 'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _,
      'k', _, _, _, 'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 's', _,
      'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _,
      'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _, 'k', _, 'h', _,
      'k', _, 'h', _, 'k', _, 'h', _, 'k', 'h', 'k', 'h', 'k', 's', 'h', 'k',
    ],
  },
  weddingEnd: {
    ...
    drum: ['h', _, _, 'h', _, _, 'h', _, 'h', _, 'h', _, 'h', _, 'h', _,
      'h', _, 'h', _, 'h', _, 'h', _, 'h', _, 'h', _, 'h', 'h', 'h', 'h'],
  },
};
